...
@Component({
  selector: 'app-tai-seleccionar',
  templateUrl: './tai-seleccionar.component.html',
  styleUrls: ['./tai-seleccionar.component.css']
})
export class TaiSeleccionarComponent implements OnInit {
